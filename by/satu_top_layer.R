...
simu.dir="/pic/scratch/song884/fy2018/by_1a/"
scripts.dir="/people/song884/dust/fy2018/by_1a/scripts/"
figure.dir="/people/song884/dust/fy2018/by_1a/figures/"
...
legend.index = c(1,seq(50,250,50))
...
for (icase in c("base",cases))
{
    ...
    case.data = read.table(
        paste(simu.dir,icase,"/tec_data/output.dat",sep=""),
        skip=3)
    top.satu[[icase]] = rbind(spinup.data[,c(1,3)],case.data[,c(1,3)])
}
